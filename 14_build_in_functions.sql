...
select concat_ws('-', '2024', '03', '04');		-- 사이사이에 -를 넣어준다.
...
select
	elt(2, '사과', '딸기', '바나나'),			-- 2번 재는 딸기
    field('딸기', '사과', '딸기', '바나나'),     -- 딸기는 2번 째
...
select format(123123123123.1231231321434, 3);
...
-- lpad(문자열, 길이, 채울 문자열), rpad(문자열ㅇ, 길이, 채울 문자열)
...
select daadate('2024-03-04', interval 6 year);

select subdate('2024-03-04', interval 30 day);		-- 얘는 빼기
